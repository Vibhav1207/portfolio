  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        <div className="absolute top-1/4 left-1/4 w-[350px] h-[350px] rounded-full bg-violet-600/5 blur-[120px] animate-pulse-glow" />
        <div className="absolute bottom-1/4 right-1/3 w-[400px] h-[400px] rounded-full bg-indigo-600/5 blur-[140px] animate-pulse-glow" style={{ animationDelay: "-4s" }} />
      </div>
